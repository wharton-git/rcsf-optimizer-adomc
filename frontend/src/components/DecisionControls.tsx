        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-950/70 p-4">
            ...
            <div className="mt-4 space-y-4">
                {criteria.map(criterion => {
                    ...
                    const weightValue = request.weights[weightKey];
                    ...
                    return (
                        <div key={criterion.id} className="rounded-xl border border-slate-800 bg-slate-900/80 p-3">
                            <div className="flex items-center justify-between gap-3">
                                ...
                                <span className={`rounded-full px-2 py-1 text-[10px] font-bold uppercase tracking-[0.18em] ${criterion.goal === 'maximize'
                            ...
                            <div className="mt-3 flex items-center gap-3">
                                <input
                                    ...
                                    step="1"
                                    value={weightValue}
                                    onChange={(event) => onWeightChange(weightKey, Number(event.target.value))}
